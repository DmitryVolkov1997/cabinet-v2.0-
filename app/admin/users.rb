ActiveAdmin.register User do
  ...
  config.xls_builder.delete_columns :id, :first_name, :last_name, :patronymic, :birthday, :socialstatus, :email, :phone, :created_at, :updated_at
  ...
  config.xls_builder.column('socialstatus') do |user|
  ...
  config.xls_builder.column('created_at') do |user|
